...
namespace PrimeAnalyticsAddin.WorkBookUtilities
{
    class ExcelUtilities
    {
        ...
        public void insertDataTabelInSheet (DataTable table, string sheetName)
        {
            ...
            sl.ImportDataTable(startingRow, startingColumn, table, true);

            int endIndex = startingRow + table.Rows.Count - 1;
        }       
