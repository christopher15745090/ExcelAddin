...
namespace PrimeAnalyticsAddin.UserControls
{
    ...
    public partial class PushToCloudNew : Window
    {
        ...
        private void btnPreview_Click(object sender, RoutedEventArgs e)
        {
            ...
            PrimeAnalyticsAddin.DebugUtilities.QuickViewDataTable viewer = new PrimeAnalyticsAddin.DebugUtilities.QuickViewDataTable();

            viewer.viewDataTable(table);

            //Excel.Range rng = (Excel.Range) ExcelUtilities.getRange(activeWorksheet);
            ...
            //MessageBox.Show(rowCount.ToString() + " : " + columnsCount.ToString());
